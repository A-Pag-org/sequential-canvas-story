  ...
  if (activeModule === "MRS") {
    return (
      <div className="space-y-6">
        ...
        <IssuesChart
          title="Total malba generated by city (Table 1)"
          data={[
            { name: "Baharudgarh", raised: undefined as any },
            { name: "Delhi", raised: 6000 },
            { name: "Faridabad", raised: undefined as any },
            { name: "Ghaziabad", raised: 325 },
            { name: "Greater Noida", raised: undefined as any },
            { name: "Gurgaon", raised: undefined as any },
            { name: "Manesar", raised: undefined as any },
            { name: "Noida", raised: undefined as any },
          ] as any}
          type="bar"
          showTarget={false}
          showActual={true}
